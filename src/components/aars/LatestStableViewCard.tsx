      ...
      <section className="card stable-card" aria-labelledby="stable-view-title">
        <div className="card-header">
          ...
          <p className="card-copy">
            ...
            and what work can continue from it without reopening broader system
            definition.
          </p>
        </div>
  ...
  return (
    <section className="card stable-card" aria-labelledby="stable-view-title">
      <div className="card-header">
        ...
        <p className="card-copy">
          The Latest Stable View is the continuity spine for safe continuation. It
          should be stronger than raw activity logs and clearer than a generic status
          summary.
        </p>
      </div>
