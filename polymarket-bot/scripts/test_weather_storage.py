...
repo.save_probability_view(prob)

print(repo.list_weather_descriptors())
print(repo.get_latest_evidence_pack(descriptor.market_id))
print(repo.get_latest_weather_view(descriptor.market_id))
print(repo.get_latest_probability_view(descriptor.market_id))
