...
import { CompletedItemsPanel } from "../components/aars/CompletedItemsPanel";
import { CurrentObjectivePanel } from "../components/aars/CurrentObjectivePanel";
import { CurrentStepIdentityPanel } from "../components/aars/CurrentStepIdentityPanel";
...
import { OpenItemsPanel } from "../components/aars/OpenItemsPanel";
  ...
  return (
    <div className="page-frame">
      ...
      <div className="step-grid">
        ...
        <CurrentStepIdentityPanel
          currentStep={payload.currentStep}
          project={payload.project}
        />
        <HealthSnapshotCard health={payload.health} />
        <CurrentObjectivePanel currentStep={payload.currentStep} />
        <NextStepRecommendationCard
          nextStepControl={payload.nextStepControl}
          currentStep={payload.currentStep}
        />
        <CompletedItemsPanel completedItems={payload.completedItems} />
        <OpenItemsPanel openItems={payload.openItems} />
